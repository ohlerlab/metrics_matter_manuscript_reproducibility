...
model_param_mapping['Liam_x1'] = {}
model_param_mapping['Liam_x1']['setup_anndata_params'] = {'batch_key': 'sample', 'rna_only': True}
model_param_mapping['Liam_x1']['Liam_params'] = {'adversarial_training': True, 'n_latent': 20,
